...
const Tag: React.FC<Props> = ({ content }: Props) => {
  ...
  return (
    <span
      className={clsx(
        "inline-block align-baseline rounded-md bg-primary/10 px-2 py-1 text-xs font-medium text-primary ring-1 ring-inset ring-primary/20 dark:bg-primary/10 dark:text-primary dark:ring-primary/20",
